          ...
          <CardContent className="pt-6 space-y-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                {fundFit.fund_return_potential || "Not evaluated"} — Requires exit of ${fundFit.ownership_scenarios?.required_exit_value_1x_fund ? (fundFit.ownership_scenarios.required_exit_value_1x_fund / 1000000).toFixed(1) + "M" : "N/A"} to return 1x of the fund.
              </p>
            </div>
            <div className="pt-4 border-t">
