    ...
    return (
      <div className="max-w-3xl mx-auto mt-12">
        <EmptyState 
          ...
          description={`The due diligence for ${deal.startup_name} is incomplete. Generate the IC Memo once all blockers are resolved.`}
      ...
      <div className="flex items-center justify-between print:hidden">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Generated by Apex AI. Final review required before IC meeting.
          </p>
        </div>
